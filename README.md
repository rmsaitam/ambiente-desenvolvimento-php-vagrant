...
Configuração do Vagrant (com provisionamento em Shell Script) para criar uma máquina virtual (Ubuntu Server 17.04 32 Bits) de desenvolvimento em PHP.
...
- git clone https://github.com/rmsaitam/ambiente-desenvolvimento-php-vagrant.git ( Execute o comando no seu Prompt/Terminal )

* Ainda no Prompt de comando/Terminal Entre no diretório ambiente-desenvolvimento-php-vagrant  ( Ou o que você definir na hora da clonagem )
